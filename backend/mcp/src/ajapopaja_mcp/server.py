...
async def update_task_design_doc(task_id: str, design_doc: str, version: int) -> str:
    ...
    try:
        ...
        return f"Error: {str(e)}. Please fetch the task again to get the latest version."
    except Exception as e:
        return f"An unexpected error occurred: {str(e)}"

@mcp.tool()
async def complete_task(task_id: str, commit_hash: str, completion_info: str, version: int) -> str:
    """
