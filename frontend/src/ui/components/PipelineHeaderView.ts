...
export class PipelineHeaderView {
  static render(props: PipelineHeaderViewProps): string {
    ...
    const gitStatusHtml = !gitStatus ? '' : `
      <div class="flex items-center gap-3 bg-app-bg px-3 py-1.5 rounded-xl border border-app-border h-[42px] cursor-pointer transition-all hover:border-app-accent-2/50 group/git" title="Workspace Git Status (Staged, Unstaged, Untracked)">
