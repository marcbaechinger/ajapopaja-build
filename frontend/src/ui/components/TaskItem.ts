          ...
          <div class="flex items-center gap-3">
            ...
            <div class="title-container flex flex-col" data-task-id="${taskId}" data-version="${task.version}">
              ...
              <div class="flex items-center gap-2 mt-1" data-task-id="${taskId}">
                ...
                ${isImplemented ? `
                  <button data-action-click="trigger_docbot" data-task-id="${taskId}" class="p-1 hover:bg-app-surface text-app-muted hover:text-green-600 rounded transition-all cursor-pointer group/docbot" title="Trigger DocBot">
